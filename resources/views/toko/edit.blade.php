...
@section('content')
    <div class="container">
        <div class="page-header">
            <h1><i class="fas fa-store"></i> Edit Toko</h1>
            ...
            <form action="{{ route('toko.update', $toko->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="nama_toko" name="nama_toko" class="form-control"
                        placeholder="Masukkan nama toko" value="{{ old('nama_toko', $toko->nama_toko) }}" required>
                </div>

                <div class="form-group">
                    <label for="alamat">Alamat</label>
                    <textarea id="alamat" name="alamat" class="form-control" rows="4" placeholder="Masukkan alamat toko">{{ old('alamat', $toko->alamat) }}</textarea>
                </div>
