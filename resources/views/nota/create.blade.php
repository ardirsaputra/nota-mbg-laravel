...
@section('content')
    <div class="container">
        ...
        <div class="form-card">
            ...
            <form action="{{ route('nota.store') }}" method="POST" id="notaForm">
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label for="no">No Nota <small
                                style="font-weight:400;text-transform:none;color:#94a3b8">(kosongkan untuk
                                auto)</small></label>
                        <input type="text" id="no" name="no" placeholder="Auto-generate"
            ...
            {{-- Tambah Barang Modal – visible to all authenticated users --}}
                ...
                <div class="modal-dialog" style="width:640px;max-width:96%;background:#fff;">
                    ...
                    <form id="addBarangForm" onsubmit="event.preventDefault(); submitNewBarang();"
                        ...
                        <div style="grid-column:1 / -1;">
                            ...
                            <div id="uraianError" style="color:#dc2626;display:none;margin-top:6px;font-size:0.85rem">
                            </div>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input id="newProfitPerUnit" name="profit_per_unit" type="number" step="1"
                                value="0" class="modal-input" style="text-align:right;"
                                placeholder="0 = auto-hitung">
                        </div>
